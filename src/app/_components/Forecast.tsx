...
export default function Forecast({ weather }: Readonly<Props>) {
  return (
    <section className="bg-pink-700 p-2 nm-inset-pink-700">
      <h2 className="2xl font-semibold">Forecast</h2>
      <div className="">

      <div className="m-2">
        {weather.forecast.forecastday.map((day: Forecastday) => (
          <div key={day.date_epoch} className="min-w-28 flex justify-around items-end py-4 pb-6 nm-flat-pink-700 rounded my-2 p-2">
